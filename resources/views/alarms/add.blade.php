        ...
        <div class="panel panel-default">
          ...
          @if(count($devices)>0)
            <div class="panel-body">
                ...
                {!! Form::open(array('action' => 'DevicesController@alarmStore')) !!}
                ...
                {!! Form::button('<i class="fa fa-plus" aria-hidden="true"></i>&nbsp;' . 'add alarm', array('class' => 'btn btn-success btn-flat margin-bottom-1 pull-right','type' => 'submit', 'method' => 'POST' )) !!}
